...
@section('content')
    ...
    <h2>{{$listings_count}} Listings Product</h2>
    <br />
...
<table class="table table-sm table-striped">
  <thead class="thead- border-0">
    <tr>
      <th scope="col"  class="w- border-0">ID</th>
      <th scope="col" class="w-50 border-0">Title</th>
      <th scope="col" class="w-25 border-0">Merchant</th>
  ...
  <tbody>
      ...
      <tr>
        ...
        <td>
          @if($item->is_disabled !='') 
            <b>Disable Listing</b>
          @elseif($item->is_disabled =='' && $item->is_admin_verified !='') 
            <b>Publish</b>
          @else
            <b>Disable Listing</b>
          @endif
